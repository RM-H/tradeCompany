  ...
  return(
      <>
          ...
          <div className='columns container'>
              ...
              <div className='column is-12 px-4 has-text-centered' >
                  <h1 className='is-size-1 has-text-centered my-3'>
                  ...
                  <article className='is-size-4 my-3 has-text-justified px-3'>
